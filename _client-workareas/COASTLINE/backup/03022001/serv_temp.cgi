...
$filename = "content/services/$sub_link.txt";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr valign="top"> 
    <td width="50%" height="145" valign=top><img src="images/illus_services.jpg"></td>
    <td height="145"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr valign="top" align="left"> 
          <td height="127"><img src="images/title_services.jpg"></td>
        </tr>
      </table>
    </td>
  </tr>
