...
$filename = "content/support/$sub_link.txt";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr valign="top"> 
    <td width="50%" height="145" valign=top><img src="images/illus_support.jpg"></td>
    <td height="145"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr valign="top" align="left"> 
          <td height="127"><img src="images/title_support.jpg"></td>
        </tr>
      </table>
    </td>
  </tr>
