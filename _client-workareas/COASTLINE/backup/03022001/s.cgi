#!/usr/local/bin/perl
#Change the above line to reflect the location of your perl interpreter.
##################################################################################
...
my $file_name;
	...
	$search_terms =~ s/\\//g;
        ...
        print "<!--<B>".scalar(@files_to_be_searched)."File(s) Searched --><b>".scalar(@file_names_to_display)."</b> possible match(es) found...<BR><br><HR ALIGN=CENTER WIDTH=65%>";
        print "</CENTER>";
	print @header;
        ...
        foreach $file_name (@file_names_to_display)
        {
                ...
                print "<BR><table class=\"regtextnobold\" width=\"100%\"><TR><TD width=\"100%\"><font class=regtextnobold><A HREF=\"$name_of_URI$file2\" target=\"_top\" class=\"innerlink\">$title_array{\"$file_name\"}</a></li><BR>";
                print "<!--<I><B>&nbsp;Modified:</B>$mod_time</I><BR>-->";
##print "<b><li>Link:</b>&nbsp;<A HREF=\"$name_of_URI$file2\" target=\"_top\" class=\"innerlink\">$file1</A></li><BR>";
                print "<B>Description:</B> $desc_array{\"$file_name\"}<BR>" if (($desc1 eq "1") || ($desc2 eq "1"));
                print "<BR>";
                print "$line_array{\"$file_name\"}<br><hr width=65\% align=center>" if ($output_line eq "1");
...
print $output "<!--<B>".scalar(@files_to_be_searched)."File(s) Searched --><b>".scalar(@file_names_to_display)."</B> possible match(es) found...<BR><br><HR ALIGN=CENTER WIDTH=65%>";
...
<title>Coastline Micro Inc. - Site Search</title>
...
<body bgcolor="#ffffff" text="#333366" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="toggle()" onResize="reload()">
    ...
    <td height="145"> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr valign="top" align="left"> 
          <td height="127"><img src="images/title_search.jpg"></td>
        </tr>
      </table>
    </td>
  </tr>
...
<table align="center" cellpadding=0 cellspacing=0 border=0>
  <tr> 
    ...
    <td bgcolor="#8f8fab" width="273" align="center"><b><font class="tableheading">Coastline Site Search Results</font></b></td>
    <td width="12" height="24" valign=top><img src="images/table_top_right.gif" border=0></td>
  </tr>
  <tr> 
    <td width="12" colspan="5" bgcolor="#333366" valign=top> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td colspan="2"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td colspan="5"> 
                        <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr> 
                            <td colspan=5 height=20><font size="-4">&nbsp;</font></td>
                          </tr>
                          <tr> 
                            <td width=10>&nbsp;</td>
                            <td colspan="3" valign=top><font class="regtextnobold"> 
                              <p>
...
print "<!--<CENTER>Case:$get_case | Type:$get_type | Construct:$get_construct | Hits Per Page:$get_hits | Terms:$search_terms</CENTER><BR><BR>-->";
        print<<"ENDPRINT";
        <CENTER><BR><P>No successful matches were found after the search.
	Please try a different search.</P></CENTER><br>
