...
$filename = "content/about/$sub_link.txt";
...
<html>
<head>
<script language="Javascript" language="JavaScript" src="js/reload.js"></script>
...
<script language="JavaScript" language="JavaScript" src="js/dynlayer.js"></script>
<script language="JavaScript" language="JavaScript" src="js/list.js"></script>
<script language="JavaScript" language="JavaScript" src="js/menulist.js"></script>
<script language="JavaScript" language="JavaScript" src="js/menu_construct.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr valign="top"> 
    <td width="50%" height="145" valign=top><img src="images/illus_about.jpg"></td>
    <td height="145"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr valign="top" align="left"> 
          <td height="127"><img src="images/title_about.jpg"></td>
        </tr>
      </table>
    </td>
  </tr>
