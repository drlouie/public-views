...
$filename = "content/products/$sub_link.txt";
...
##check to see if body background image is dynamic
if ($FORM{'title'}) { 
$title = "$FORM{'title'}";
$background = "<STYLE TYPE=\"text/css\">body { background-image: url(images/background_$title.jpg); background-repeat: no-repeat }</STYLE>";
$illustration = "";
 }

##if not add default background
else { 
$title = "products";
$background = "<STYLE TYPE=\"text/css\">body { background-image: url(images/background.jpg); background-repeat: no-repeat }</STYLE>";
$illustration = "<img src=\"images/illus_products.jpg\">";
}
...
<LINK REL="STYLESHEET" HREF="common_css.cgi?nobody=1" Type="text/css">
</head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr valign="top"> 
    <td width="50%" height="145" valign=top>$illustration</td>
    <td height="145"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr valign="top" align="left"> 
          <td height="127"><img src="images/title_$title.jpg"></td>
        </tr>
      </table>
    </td>
  </tr>
