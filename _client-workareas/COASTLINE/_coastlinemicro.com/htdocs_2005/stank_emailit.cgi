...
else { $EmailSubject = "Some Subject"; }
  ...
  <tr> 
    ...
    <td width="348" valign="top"> 
                                <table width="300" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr> 
                                    ...
                                    <td height="350" align="center"><nobr> 
									  ...
									  <input type="text" name="LeURL" value="http://www.rhomberg.com/systemConfigurator/$MyURL" onFocus="javascript:alert(this.value);document.EmailIt.MyEmail.focus();" class="inputtext15">
									  <br>
                                      <br>
                    ...
                    <input type="reset" value="Reset Form" name="reset" class="inputbut">
                                      ...
                                      <input type="hidden" name="MyPageURL" value="http://www.rhomberg.com/systemConfigurator/$MyURL">
