...
## ----------------------->>> SEND EMAIL MESSAGE
	my $SenderIn = "admin\@rhomberg.com(Ecom Store)";
	use lib "/www/htdocs/MIME-Lite-2.117/lib/";
    use MIME::Lite;
        my $msg = MIME::Lite->new(
                     From    =>$SenderIn,
                     To      =>$Email,
                     Subject =>'System - Retrieve Password',
...
<table width="400" border="0" cellspacing="0" cellpadding="0" align="center"><tr><td width="100%" valign="top"><font face="verdana,arial,helvetica" size="1" color="#333366">$FirstName,<br><br>Here is your login information as you requested. The Store features a fully functional System Configurator.<br><br><b>Username</b> - $Username<br><b>Password</b> - $Pass<br><br>Your account is valid ONLY within our Interactive E-Com Store.<br><ul><li>System Admin<br><a href="http://www.rhomberg.com/systemConfigurator/">http://www.rhomberg.com/systemConfigurator/</a></li><li>Did not request this info?<br><a href="mailto:admin\@rhomberg.com?Subject=Request Password Fraud (Ecom Store)">Report It</a></li></ul></font></td></tr></table>
...
#-	my $SubjectIn = "System Login - Retrieve Password";
#-	my $BodyIn = "$FirstName,\n\nHere is login information for your account as requested. \n\nUsername - $Username\nPassword - $Pass\n\nYour account is valid within the system, our ECom Store.\n\nECom Store: http://www.rhomberg.com/systemConfigurator/\n\nDid not request this info?: admin\@rhomberg.com\n\n\n";
#-	my $Attach1In = "";
#-	my $Attach2In = "";
#-	my $Attach3In = "";
#-	my $Number = "$TheNumber";
...
<html>
<head>
<title>System Login - Retrieve Password</title>
      ...
      <td align="center" width="50%" valign="middle"><img src="images/splash_logos.jpg" width="166" height="164"><br>
        ...
        <table width="350" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td rowspan="6"s><font face="verdana,arial,helvetica" size="1" color="#333366">To retrieve your password please fill out these form fields. All information you input must match the information saved in your user profile. If you have any problems please ask a Company Representative for further assistance.<br></font></td>
          </tr>
          <tr> 
            <td width="135"> 
