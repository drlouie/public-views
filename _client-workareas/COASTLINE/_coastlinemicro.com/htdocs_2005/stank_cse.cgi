...
<LINK REL="STYLESHEET" HREF="http://www.rhomberg.com/systemConfigurator/common_css.html?anchor=333366&anchorov=EB0000&weight=normal&weightov=normal&decor=underline&decorov=underline" Type="text/css">
<STYLE TYPE="text/css">
...
###########
my $SenderIn = "Configs\@coastlinemicro.com(E-Com Store)";
use lib "/www/htdocs/MIME-Lite-2.117/lib/";
use MIME::Lite;
my $msg = MIME::Lite->new(
				From    =>$SenderIn,
                To      =>$Email,
                Subject =>'Copy Of: Your EQuote Request',
                Type    =>'multipart/related'
                );
   $msg->attach(Type => 'text/html',
   Data => qq{ 
...
<html>
<head>
<title>E-Com Store - Configuration Saved</title>
<LINK REL="STYLESHEET" HREF="http://www.rhomberg.com/systemConfigurator/commoncss.html" Type="text/css">
</head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" background="http://www.rhomberg.com/systemConfigurator/images/newones/top_tablebg_main.jpg" height="100">
  <tr> 
    <td width="30%"><img src="http://www.rhomberg.com/systemConfigurator/images/newones/illus_products.jpg" width="250" height="100" border="0"></td>
    <td align="right" valign="middle" width="70%"><font size="1" color="#ffffff" face="verdana,arial,helvetica">$date&nbsp;&nbsp;<font size="3">&nbsp;</font></font>
	<center><img src="http://www.rhomberg.com/systemConfigurator/images/newones/title_$ITitle.jpg" width="350" height="80" align="bottom"></center></td>
  </tr>
</table>

<table width="400" border="0" cellspacing="0" cellpadding="0" align="center"><tr><td width="100%" valign="top">
<font face="verdana,arial,helvetica" size="1" color="#333366">$FirstName,<br><br>You have successfully saved your new $CMSeries&#153; Series configuration. This configuration will be saved for a total of 30 days.<br><br>All <b>$Cookies{'CoNo'}</b> users can review/purchase this system securely online by logging onto the with their own username/password.<br><ul><li><b>Your $CMSeries&#153; Series Configuration</b><br><a href="http://www.rhomberg.com/systemConfigurator/stank_vconfig.html?CID=$LastOne">$ItemName</a></li><li><b>E-Com Store</b><br><a href="http://www.rhomberg.com/systemConfigurator/">http://www.rhomberg.com/systemConfigurator/</a></li><li><b>Did not reque