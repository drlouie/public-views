...
if ($FORM{'title'}) { 
	...
	$filename = "content/about/$title.txt";
	$dropme = `cat $filename`;
	$legal = `cat legal.nsf`;
...
<html>
<head>
<title>Coastline Micro Inc. - About Our Company</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" background="images/newones/top_tablebg_main.jpg" height="100">
  <tr> 
	...
	<center><img src="images/newones/title_aboutus.jpg" width="350" height="80" align="bottom"></center></td>
  </tr>
</table>
<!-- End header table -->
