...
if ($FORM{'Username'} && $FORM{'Password'}) {
	...
	if ($Pass eq $Password) {
		...
		&SetCookies('CMCustNum',$ThyCustNum);
		...
		if ($lasturl) { print "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"1;URL=http://www.rhomberg.com$lasturl\" TARGET=\"_top\">"; }
		else { print "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"1;URL=index.cgi\" TARGET=\"_top\">"; }
        ...
        <table width="350" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td rowspan="4"><font face="verdana,arial,helvetica" size="1" color="#333366">To 
              ...
              please contact a system administrator or your manager.<br>
              <br>
              <center>
                <a href="getpass.cgi"><font color="red">Forgot your password?</font></a> 
              </center>
