...
if (($Cookies{'UserType'} eq "COManage") || ($Cookies{'UserType'} eq "WEBAdmin") || ($Cookies{'UserType'} eq "COSales") || ($Cookies{'UserType'} eq "COUser")) { $nextone = "1"; }
else {
...
EOF
	...
	$dbh->{RaiseError} = 1; 
	my $count=0;
	my $queeery = "SELECT * FROM DISTs WHERE $SortBy LIKE '%$FormInput%' ORDER BY $SortBy";
	...
	while(@row = $sth->fetchrow_array) { 
		...
		if ($SortBy eq "Name") { print "<tr><td width=\"5%\" align=\"center\"><font class=\"sresults1\">$count</font></td><td width=\"10%\" align=\"center\"><font class=\"sresults1\"><a href=\"change_dist.cgi?DISTID=$SavedDISTID&Name=$SavedName\" class=\"sresults1\">$SavedName</a></font></td><td align=\"left\" width=\"25%\"><font class=\"sresults1\">$SavedURL</font></td><td width=\"20%\" align=\"left\"><font class=\"sresults1\">$SavedCity</font></td><td width=\"20%\" align=\"left\"><font class=\"sresults1\">$SavedState</font></td><td width=\"10%\" align=\"center\"><font class=\"sresults1\">$AreaCode-$PhoneNum3-$PhoneNum4<br></font></td><td width=\"10%\" align=\"center\"><a href=\"change_dist.cgi?DISTID=$SavedDISTID&Name=$SavedName\"><img src=\"images/icon_change_off.gif\" border=\"0\" onMouseOver=\"javascript:iconOn(this,'change','on');\" onMouseOut=\"javascript:iconOff(this,'change','off');\"></a>&nbsp;&nbsp;<a href=\"#\" onClick=\"javascript:deleteThis('$SavedDISTID','$SavedName');\"><img src=\"images/icon_delete_off.gif\" border=\"0\" onMouseOver=\"javascript:iconOn(this,'delete','on');\" onMouseOut=\"javascript:iconOff(this,'delete','off');\"></a></td></tr>"; }
		if ($SortBy eq "URL") { print "<tr><td width=\"5%\" align=\"center\"><font class=\"sresults1\">$count</font></td><td align=\"left\" width=\"25%\"><font class=\"sresults1\">$SavedURL</font></td><td width=\"10%\" align=\"center\"><font class=\"sresults1\"><a href=\"change_dist.cgi?DISTID=$SavedDISTID&Name=$SavedName\" class=\"sresults1\">$SavedName</a></font></font></td><td width=\"20%\" align=\"left\"><font class=\"sresults1\">$SavedCity</font></td><td width=\"20%\" align=\"left\"><font class=\"sresults1\">$SavedState</font></td><td width=\"10%\" align=\"center\"><font class=\"sresults1\">$AreaCode-$PhoneNum3-$PhoneNum4</font></td><td width=\"10%\" align=\"center\"><a href=\"change_dist.cgi?DISTID=$SavedDISTID&Name=$SavedName\"><img src=\"images/icon_change_off.gif\" border=\"0\" onMouseOver=\"javascript:iconOn(this,'change','on');\" onMouseOut=\"javascript:iconOff(this,'change','off');\"></a>&nbsp;&nbsp;<a href=\"#\" onClick=\"javascript:deleteThis('$SavedDISTID','$SavedName');\"><img src=\"images/icon_delete_off.gif\" border=\"0\" onMouseOver=\"javascript:iconOn(this,'delete','on');\" onMouseOut=\"javascript:iconOff(this,'delete','off');\"></a></td></tr>"; }
		if ($SortBy eq "MailCity") { print "<tr><td width=\"5%\" align=\"center\"><font class=\"sresults1\">$count</font></td><td width=\"20%\" align=\"left\"><font class=\"sresults1\">$SavedCity</font></td><td width=\"20%\" align=\"left\"><font class=\"sresults1\">$SavedState</font></td><td align=\"left\" width=\"25%\"><a href=\"change_dist.cgi?DISTID=$SavedDISTID&Name=$SavedName\" class=\"sresults1\">$SavedName</a></font></td><td width=\"10%\" align=\"center\"><font class=\"sresults1\">$SavedURL</font></td><td width=\"10%\" align=\"center\"><font class=\"sresults1\">$AreaCode-$PhoneNum3-$PhoneNum4</font></td><td width=\"10%\" align=\"center\"><a href=\"change_dist.cgi?DISTID=$SavedDISTID&Name=$SavedName\"><img src=\"images/icon_change_off.gif\" border=\"0\" onMouseOver=\"javascript:iconOn(this,'change','on');\" onMouseOut=\"javascript:iconOff(this,'change','off');\"></a>&nbsp;&nbsp;<a href=\"#\" onClick=\"javascript:deleteThis('$SavedDISTID','$SavedName');\"><img src=\"images/icon_delete_off.gif\" border=\"0\" onMouseOver=\"javascript:iconOn(this,'delete','on');\" onMouseOut=\"javascript:iconOff(this,'delete','off');\"></a></td></tr>"; }
		if ($SortBy eq "MailState") { print "<tr><td width=\"5%\" align=\"center\"><font class=\"sresults1\">$count</font></td><td width=\"20%\" align=\"left\"><font class=\"sresults1\">$SavedState</a></font></td><td width=\"20%\" align=\"left\"><font class=\"sresults1\">$SavedCity</font></td><td align=\"left\" width=\"25%\"><a href=\"change_dist.cgi?DISTID=$SavedDISTID&Name=$SavedName\" class=\"sresults1\">$SavedName</a></font></td><td width=\"10%\" align=\"center\"><font class=\"sresults1\">$SavedURL</font></td><td width=\"10%\" align=\"center\"><font class=\"sresults1\">$AreaCode-$PhoneNum3-$PhoneNum4</font></td><td width=\"10%\" align=\"center\"><a href=\"change_dist.cgi?DISTID=$SavedDISTID&Name=$SavedName\"><img src=\"images/icon_change_off.gif\" border=\"0\" onMouseOver=\"javascript:iconOn(this,'change','on');\" onMouseOut=\"javascript:iconOff(this,'change','off');\"></a>&nbsp;&nbsp;<a href=\"#\" onClick=\"javascript:deleteThis('$SavedDISTID','$SavedName');\"><img src=\"images/icon_delete_off.gif\" border=\"0\" onMouseOver=\"javascript:iconOn(this,'delete','on');\" onMouseOut=\"javascript:iconOff(this,'delete','off');\"></a></td></tr>"; }
	}
	$sth->finish; 
	$dbh->disconnect; 
...
EOF
	...
	$dbh->{RaiseError} = 1; 
	my $count=0;
	my $queeery = "SELECT * FROM DISTs ORDER BY $SortBy";
	my $sth = $dbh->prepare("$queeery");
	$sth->execute or die "Unable to execute query\n"; 
	my @row;
	while(@row = $sth->fetchrow_array) { 
