...
<html>
<head>
<title>QISV Catalogue Administration System</title>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="5">
                      <tr> 
                        <td height="100" valign="top" colspan="2"><font face="verdana,arial,helvetica" size="1" color="#333366"><b>Function 
                          ...
                          to the QISV catalogue administration 
                          ...
                          brief the IT Director of the problem 
...
foreach $thecount (1 .. $currentcount) {
	...
	if ($thecount != $deleThis) {
		...
		flock(THEONE, 2);
		print THEONE "<html><head><title>Class-List $whichone - $field02</title></head>";
		print THEONE "<body background=\"../../images/qisvbkgd.gif\">";
		print THEONE "<CENTER><h2><font face=verdana, arial, helvetica>Company Name<br><br>VID # 1-33-056-4458-800";
		...
		print THEONE "<font face=verdana, arial, helvetica size=2><center>If you have any questions, comments or suggestions, please <font COLOR=#0000FF><a href=\"framer.cgi?new_url=cont_temp.cgi&sub_link=gencomments\">E-Mail</a></font> us directly!</center></font>";
	...
	flock(INDEXFILE, 2);
	print INDEXFILE "<html><head><title>QISV Catalogue</title>";
