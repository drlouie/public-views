...
<html>
<head>
<title>Shark Tank Admin System - Inventory Administration</title>
                                ...
                                <td width="348" valign="top"> 
                                  <table width="500" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr> 
                                      ...
                                      <td height="75" bgcolor="#F2F2F7" align="left"><font face="verdana,arial,helvetica" size="1" color="#333366">To view or update a product in the system please select the type of product you are going to view/update. Then, type in the the <b>Part Number</b> for the product you would like to view/update then click 'View/Update'<br><br><font color="#EB0000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>1. Product Type</b>&nbsp;&nbsp;&nbsp;&nbsp;->->->&nbsp;&nbsp;&nbsp;&nbsp;<b>2. CM Part Number</b>&nbsp;&nbsp;&nbsp;->->->&nbsp;&nbsp;&nbsp;<b>3. Click Button</b></font></font></td>
                                      <td width="15" bgcolor="#F2F2F7">&nbsp;</td>
                                    </tr>
                                    <tr> 
                                      <td width="15" bgcolor="#F2F2F7">&nbsp;</td>
...
var InternalPartNum = document.change.InternalPartNum.value;
...
else if ((InternalPartNum == " ") || (InternalPartNum == "")) {
	thefirst = "InternalPartNum";
    missingdrop += "\\nYou must type in a Part Number to continue...";
}
...
if (missingdrop != "") {
	...
	if ((formindex == 1) || (formindex == 2) || (formindex == 3)) {
		location.href='change_product_system.cgi?InternalPartNum='+InternalPartNum+'&PricingClass='+thisone+'';
		return false;
	}
	else {
		location.href='change_product_common.cgi?InternalPartNum='+InternalPartNum+'&PricingClass='+thisone+'';
		return false;	
	}
}
}
...
EOF
	...
	my @row;
		...
		print "<option value=\"$CID\">$ComponentName</option>";
	}
	$sth->finish;
	$dbh->disconnect;
...
<select name="InternalPartNum" class="inputtext">
</select>
...
function testSysComponentAdd() {
	var formindex = document.add.ProductType.selectedIndex;
	var thisone = document.add.ProductType.options[formindex].value;
	if (thisone == 'ADDCOMPONENT') { 
		showAddComponent();
		document.add.ProductType.selected = 0;
		return false;
	}
	else return false;
}
function showAddComponent() {
	parent.document.location.href = 'add_componentType.cgi?enformthee=1';
}
</SCRIPT>
<select name="ProductType" class="inputtext" onChange="testSysComponentAdd();">
<option value="BIGNULL" SELECTED>:::::  Configurables  :::::</option>
<option value="Desktop"> - Desktop PC</option>
<option value="Server"> - Server</option>
<option value="Notebook"> - Notebook</option>
<option value="BIGNULL"> </option>
<option value="BIGNULL">::::: Components :::::</option>
<option value="ADDCOMPONENT"> [ ADD NEW Component Type ] </option>
<option value="BIGNULL">:::::::::::::::::::::::::</option>
...
EOF
	...
	my @row;
		...
		my $ComponentName = $row[1];
		my $ComponentType = $row[2];
		print "<option value=\"$ComponentName\">$ComponentName</option>";
	}
	$sth->finish;
	$dbh->disconnect;
	## print closing select tag
