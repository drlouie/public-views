...
if (($Cookies{'UserType'} eq "COManage") || ($Cookies{'UserType'} eq "WEBAdmin")) { $nextone = "1"; }
	...
	print "Sorry, you do not have access to the press release administration system. To have your user access rights changed please contact a Supervisor or Representative.";
	print "</body></html>";
	exit;
}
    ...
    <tr valign="top"> 
      <td width="100%"><br>
        <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr> 
            <td><font face="verdana,arial,helvetica" size="1">Welcome to the press release administration system. This system allows for you, 
              ...
              this system please brief the IT Director of the problem you 
              encountered.<br>
              <br>
...
<center>###
<br><br>
<font size="1">All names are trademarks and/or registered trademarks of their respective owners</font>
<br><br>
</center>
</font>
</td></tr>
                  ...
                  <td><font face="verdana,arial,helvetica" size="1"><b>Instructions</b><br>
                    ...
                    <ul>
                      ...
                      <li>Now, type in your title in the 'Title' field. <b>Example:</b> 
                        <i>Our Company Moves Operations to new facility</i></li>
...
if (thisone1 == "none") { alert('You must select an item from the Available Footers to use this function.'); }
...
if (thisone == "none") { alert('You must select an item from the Available Footers to use this function.'); }
else { 
  ...
  <table border="1" cellspacing="0" cellpadding="0" align="center" bordercolor="#333366" width="500">
    <tr valign="top"> 
      <td width="100%" align="center"> 
        ...
        <table width="100%" border="1" bordercolor="#333366" cellpadding="3" cellspacing="0">
          <tr bgcolor="#333366"> 
            <td width="50%" height="20" bgcolor="#333366" align="center"><font face="verdana,arial,helvetica" size="1" color="#ffffff"><b>Footer </b></font></td>
          </tr>
          <tr> 
              ...
              <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr> 
                  <td colspan="3"><font face="verdana,arial,helvetica" size="1"><b>Instructions</b><br>
                    <br>
                    The Footer is used to describe your company to the user reading 
...
$whichfoot = "CompanyFoot";
require ("press/companyfoot/$whichone"); 
}
else { 
...
$thistitle = "Company Footer";
$whichfooter = "CompanyFoot";
$existing = "'Available Footers'";
$howmany = "up to <b><i>two</i></b>";
$steptwo = "Type in a link to a section or page within site that closely relates to the press release article you are creating this footer for.";
$elaborate = "Services, support, technology, past and present or basically anything that gives the press release reader a clear idea of the company";
$thisbody = "Company";
}
else { 
