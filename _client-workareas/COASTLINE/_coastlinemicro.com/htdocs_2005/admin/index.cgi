              ...
              <tr bordercolor="#333366"> 
                <td width="50%" align="center" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="10">
                    <tr> 
                      <td width="100%" height="225" valign="top"><font face="verdana,arial,helvetica" size="1" color="#333366"><br>
                        ...
                        updated or re-implemented please contact a Supervisor or Manager for further assistance. If you should 
                        recieve an error please be sure to report it immediatly 
                        along with whatever actions led to the error to: admin\@rhomberg.com</font></td>
                    </tr>
                  </table>
                </td>
              </tr>
