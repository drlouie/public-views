    ...
    <td width="25%">&nbsp;</td>
      <td align="center" width="50%" valign="middle"><img src="images/splash_logos.jpg" width="166" height="164"><br>
        ...
        <table width="350" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="100%"><font face="verdana,arial,helvetica" size="1" color="#333366">You have been successfully logged off the system. Any reports of bugs or suggestions for functionality are greatly appreciated by the Management.<br><br><center><form><input type="button" value="Re-Login" onClick="javascript:parent.location.href='login.cgi?lasturl=index.cgi'"></form></center></font></td>
          </tr>
        </table>
    </td>
      <td width="25%">&nbsp;</td>
