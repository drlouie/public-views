...
if (($FORM{'InternalCustNum'}) && ($FORM{'CompanyName'}) && ($FORM{'RepID'}) && ($FORM{'CompanyType'})) {
...
## ---------->>> IF EXISTS DIE PRINT OUT RECORD(s) THAT MATCH REQUEST
		if (($SavedInternalCustNum eq $InternalCustNum) || ($SavedCompanyName eq $CompanyName)) {
{
print <<EOF
...
<td align="center" width="15%"><font class="sresults1"><b>Company #</b><br></font></td>
...
EOF
			...
			if ($SavedInternalCustNum eq $InternalCustNum) { $SavedInternalCustNum = "<font color=\"red\">$SavedInternalCustNum</font>"}
			if ($SavedCompanyName eq $CompanyName) { $SavedCompanyName = "<font color=\"red\">$SavedCompanyName</font>"}
			if ($ZipMore > 0) { $ZipMore = "-$ZipMore"}
			$count++;
			print "<tr width=\"100%\">";
			print "<td><font class=\"stextbig\" width=\"15%\"><b>$SavedInternalCustNum&nbsp;</b></font></td>";
...
EOF
	...
	my $dbh = DBI->connect("DBI:mysql:NMS-SysConfigurator","root","62Ak.fi1HdBxI") or die "Unable to connect to database: <b>NMS-SysConfigurator</b>\n"; 
	$dbh->{RaiseError} = 1; 
	my $sth = $dbh->prepare("INSERT INTO Customers (CustomerID, InternalCustomerNumber, ShippingID, RepID, AdminID, MessageID, 
							 CompanyName, CompanyType, Phone, Fax, 
							 MailAdd, MailAdd2, MailCity, MailState, MailZip, 
							 PayOption, SeeSeeT, SeeSeeN, SeeSeeE, 
							 AddedBy, AddedOn, ModifiedBy, ModifiedOn, DeletedBy, DeletedOn, 
							 PayPi, BillingInformation, LastOrderDate,
							 CustomerServiceInfo, TechnicalSupportInfo, CustomerSince)

							 VALUES (Null, '$InternalCustNum', Null, '$RepID', Null, Null, 
							 '$CompanyName', '$CompanyType', '$Phone', '$Fax', 
							 '$MailAdd', '$MailAdd2', '$MailCity', '$MailState', '$MailZip', 
							 '$PayOption', '', '', '',
							 '$ActionUser', Null, '', '', '', '', 
							 '$PayPalInfo', '$BillingInfo', '$LastOrderDate', 
							 '$CSInfo', '$TSInfo', '$CustomerSinceDate')");

	$sth->execute or die "Unable to execute query\n"; 
	$sth->finish; 
	print "<b><br>Create Customer Account</b><br><br>The account for <b>$CompanyName</b> has been created successfully. Now you must create a User Account for the administrator of this new company account's users and profile configurations. This account will control the entire configuration and administration for the company account. Either a Company Managerr or Admin and/or the company admin can change this setting in the future.<br>";
	print "<br><br>";
	print "<center><form><input type=\"button\" value=\"Create Admin Account\" onClick=\"javascript:location.href='add_user.cgi?enformthee=1&AddAdmin=1&InternalCustNum=$InternalCustNum&CompanyName=$CompanyName'\" class=\"inputbut\"></form></center></font>";
	$dbh->disconnect; 
...
if (document.add.InternalCustNum.value == "" || document.add.InternalCustNum.value == " ") {
...
if (($Cookies{'UserType'} eq "COManage") || ($Cookies{'UserType'} eq "WEBAdmin")  || ($Cookies{'ExtraAccess'} =~ "PayOptions")) {
...
if (($Cookies{'UserType'} eq "COManage") || ($Cookies{'UserType'} eq "WEBAdmin") || ($Cookies{'ExtraAccess'} =~ "PayOptions")) { $next=1; }
...
var selectoption = "";
selectoption = "______________________________________________________________________________________                   " + "\\nYou have access to add customers to the system, yet you do not have access to grant Payment Options to customers in the system. Please make sure a Company Managerr or Accounting Rep can configure the Payment Options for this account for you as soon as you are finished with the customer addition process. All Accounting Staff will recieve a reminder to do so everytime they log on to the system until the request is fulfilled." + "\\n______________________________________________________________________________________";
alert(selectoption);
...
if (($Cookies{'UserType'} eq "COManage") || ($Cookies{'UserType'} eq "WEBAdmin") || ($Cookies{'ExtraAccess'} =~ "PayOptions")) { print "<body TEXT=\"#333366\" LINK=\"#8F8FAB\" VLINK=\"#8F8FAB\" ALINK=\"#8F8FAB\" BGCOLOR=\"#ffffff\" leftmargin=\"0\" topmargin=\"0\" marginwidth=\"0\" marginheight=\"0\"  onLoad=\"javascript:checkOptions();\">"; }
## -------------------------->>> WITHOUT
                            ...
                            <tr> 
                              ...
                              <td width="348" valign="top"> 
                                <table width="300" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
                                    <td width="15" height="15" bgcolor="#8F8FAB">&nbsp;</td>
                                    <td height="20" bgcolor="#8F8FAB"><font face="verdana,arial,helvetica" size="1" color="#333366"><b><font color="#FFFFFF">Internal Customer Number</font></b></font></td>
                                    <td width="15" height="15" bgcolor="#8F8FAB">&nbsp;</td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3" height="1"><img src="images/verticalbar.gif" width="15" height="1"></td>
                                  ...
                                  <tr> 
                                    ...
                                    <td height="65" bgcolor="#F2F2F7" align="left" valign="middle"><font face="verdana,arial,helvetica" size="1" color="#333366">Type 
                                      in the Internal Customer Number for the Company 
                                  ...
                                  <tr> 
                                    <td width="15" bgcolor="#F2F2F7">&nbsp;</td>
                                    <td height="35" align="center"> 
                                      <input type="text" name="InternalCustNum" size="15" class="inputtext15">
                                    </td>
                                    <td width="15" bgcolor="#F2F2F7">&nbsp;</td>
                                  </tr>
                                  <tr> 
                            ...
                            <tr> 
                              ...
                              <td width="348" valign="top"> 
                                <table width="300" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
                                    <td width="15" height="15" bgcolor="#8F8FAB">&nbsp;</td>
                                    <td height="20" bgcolor="#8F8FAB"><font face="verdana,arial,helvetica" size="1" color="#333366"><b><font color="#FFFFFF">Primary Account Representative</font></b></font></td>
                                    <td width="15" height="15" bgcolor="#8F8FAB">&nbsp;</td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3" height="1"><img src="images/verticalbar.gif" width="15" height="1"></td>
...
EOF
		...
		my $sth = $dbh->prepare("SELECT * FROM Users 
								 WHERE UserAccess = 'COManage' 
								 OR UserAccess = 'WEBAdmin' 
								 OR UserAccess = 'COSales'
