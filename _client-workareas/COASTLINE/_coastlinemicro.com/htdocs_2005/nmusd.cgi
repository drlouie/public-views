...
#                                                                                                     #
# drlouie's Contact Us section template. Dynamically driven by DHTML, HTML, Perl and MySql #
#                                                                                                     #
#######################################################################################################
...
if ($FORM{'title'}) { 
	...
	$powbutton = "<a href=\"javascript:checkPosition();\" onMouseOver=\"javascript:mouseOvered();\" onMouseOut=\"javascript:mouseOffed();\"><img src=\"images/newmenu/menuhide_off.gif\" name=\"powbar\" border=\"0\" width=\"174\" height=\"22\"></a><br>";
...
<body bgcolor="#ffffff" text="#333366" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="javascript:loadScript();runPow();">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="175" align=left valign=top><img src="images/newmenu/place_holder.gif" width="175" height="150">$powbutton $legal</td>
