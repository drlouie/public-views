...
<LINK REL="STYLESHEET" HREF="http://www.rhomberg.com/systemConfigurator/common_css.html" Type="text/css">
<STYLE TYPE="text/css">
    ...
    <td width="25%">&nbsp;</td>
      <td align="center" width="50%" valign="middle"><img src="images/splash_logos.jpg" width="166" height="164"><br>
        ...
        <table width="350" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="100%"><font face="verdana,arial,helvetica" size="1" color="#333366">You have been successfully logged off the system. Any reports of bugs or suggestions for functionality are greatly appreciated by the Coastline Micro Management.<br><br><center><form><input type="button" value="Re-Login" onClick="javascript:location.href='login.cgi'" class="regbut"></form></center></font></td>
          </tr>
        </table>
    </td>
      <td width="25%">&nbsp;</td>
