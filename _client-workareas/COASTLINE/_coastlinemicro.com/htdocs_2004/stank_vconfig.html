...
## SORRY YOU MUST BE LOGGED IN...
	...
	print "Content-type: text/html\n\n";
	print "<script language=\"Javascript\">parent.location.href=\"https://www.coastlinemicro.com/login.html?lasturl=stank_vconfig.html&CID=$FORM{'CID'}\";</script>";
exit;
}

## =-=-=--------->>> IF USER IS GOOD AND CID IS PASSED
sub goodone {
$MainTitle = "Shark Tank&#153; Configuration Viewer";
...
if ($FORM{'InnerLink'} eq "1") {
	$Welcome = "<a href=\"#\" onClick=\"javascript:window.close();\"><b><font class=nolink><font class=red>** NOTE **</font><br>To close this window and return to your Shark Tank™ Cart, click here at anytime...</font></b></a>";
	...
	print " 	nNews[1][\"text\"]=\"<font class=nolink><font class=red>** NOTE **</font><br>To close this window and return to your Shark Tank™ Cart, click here at anytime...</font>\"\n";
	print " 	nNews[1][\"link\"]=\"#\"\n";
	...
	$Welcome = "<font class=nolink><font class=red>Welcome to the Shark Tank™ Configuration Viewer</font><br>We hope you enjoy your stay and we welcome you, your friends and collegues to our site...</font></font>";
	print " 	nNews[0]=new Array()\n";
	print " 	nNews[0][\"text\"]=\"<font class=nolink><font class=red>** Keep in Mind **</font><br>You cannot re-configure this system, yet you can always re-configure any system in our inventory...</font>\"\n";
	print " 	nNews[0][\"link\"]=\"javascript:void(0);\"\n";
	print " 	nNews[0][\"target\"]=\"_self\"\n";
	print " 	nNews[0][\"script\"]=\"void(0);\"\n";
	print " 	nNews[1]=new Array()\n";
	print " 	nNews[1][\"text\"]=\"<font class=nolink><font class=red>Welcome to the Shark Tank™ Configuration Viewer</font><br>We hope you enjoy your stay and we welcome you, your friends and collegues to our site...</font></font>\"\n";
