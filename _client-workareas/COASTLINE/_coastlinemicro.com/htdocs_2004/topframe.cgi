...
if ($Cookies{'GID'} && ($Cookies{'UTipe'} eq "CustAdmin" || $Cookies{'UTipe'} eq "CustUser")) {
	...
	$Welcome = "<b>Welcome to the Shark Tank&#153; $Cookies{'FiNo'} $Cookies{'LaNo'}...</b><br><a href=\"logoff.cgi\" target=\"_parent\">I am not $Cookies{'FiNo'}!</a>";
	$LoginBut = "<a href=\"logoff.cgi\" onClick=\"document.images.search.src = 'images/spacer.gif';\" target=\"botOne\" onMouseOver=\"javascript:imageOn('logoff','on');\" onMouseOut=\"javascript:imageOff('logoff','off');\"><img src=\"images/dbing/button_logoff_off.gif\" width=\"75\" height=\"19\" name=\"logoff\" border=\"0\"></a>";
}
else {
	$Welcome = "<b>Welcome to the Shark Tank&#153;</b><br>Would you like to <a href=\"https://www.coastlinemicro.com/login.cgi\" onClick=\"document.images.search.src = 'images/spacer.gif';\" target=\"botOne\">Log In?</a>";
	$LoginBut = "<a href=\"https://www.coastlinemicro.com/login.cgi\" onClick=\"document.images.search.src = 'images/spacer.gif';\" target=\"botOne\" onMouseOver=\"javascript:imageOn('login','on');\" onMouseOut=\"javascript:imageOff('login','off');\"><img src=\"images/dbing/button_login_off.gif\" width=\"75\" height=\"19\" name=\"login\" border=\"0\"></a>";
}
...
<LINK REL="STYLESHEET" HREF="http://www.coastlinemicro.com/common_css.html" Type="text/css">
...
if ($Cookies{'GID'} && ($Cookies{'UTipe'} eq "CustAdmin" || $Cookies{'UTipe'} eq "CustUser")) {
	...
	print " 	nNews[0][\"text\"]=\"<font class=nolink>Welcome to the Shark Tank™ $Cookies{'FiNo'} $Cookies{'LaNo'}...</font><font class=link><br>I am not $Cookies{'FiNo'}, <font class=red>Change User!</font></font>\"\n";
	print " 	nNews[0][\"link\"]=\"#\"\n";
	print " 	nNews[0][\"target\"]=\"_self\"\n";
	print " 	nNews[0][\"script\"]=\"document.images.search.src = \'images/spacer.gif\';\"\n";
	print " 	nNews[1]=new Array()\n";
	print " 	nNews[1][\"text\"]=\"<font class=nolink>Shark Tank™ inventory is priced<br>exclusively for <font class=red>$Cookies{'CoNo'}</font></font>\"\n";
	print " 	nNews[1][\"link\"]=\"#\"\n";
	...
	print " 	nNews[2][\"link\"]=\"http://www.coastlinemicro.com/everything_intel.cgi?title=intel\"\n";
	...
	print " 	nNews[3][\"link\"]=\"http://www.coastlinemicro.com/press.cgi?viewRel=$PressNum\"\n";
	...
	print " 	nNews[0]=new Array()\n";
	print " 	nNews[0][\"text\"]=\"<font class=nolink>Welcome to the Shark Tank™, our online store...<font class=red><br>Would you like to log in?</font></font>\"\n";
	print " 	nNews[0][\"link\"]=\"https://www.coastlinemicro.com/login.cgi\"\n";
	print " 	nNews[0][\"target\"]=\"botOne\"\n";
	print " 	nNews[0][\"script\"]=\"document.images.search.src = \'images/spacer.gif\';\"\n";
	print " 	nNews[1]=new Array()\n";
	print " 	nNews[1][\"text\"]=\"<font class=nolink>To view <font class=red>your</font> company's price on<br>Shark Tank™ inventory please <font class=link>log in</font>...</font>\"\n";
	print " 	nNews[1][\"link\"]=\"https://www.coastlinemicro.com/login.cgi\"\n";
	...
	print " 	nNews[4][\"link\"]=\"http://www.coastlinemicro.com/services.cgi?title=tigerNAS\"\n";
