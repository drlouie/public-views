...
#                                                                                                         #
# CoastlineMicro.com's customer support section template. Dynamically driven by DHTML, HTML, Perl and     #
# MySql                                                                                                   #
#                                                                                                         #
...
if ($FORM{'title'}) { 
	...
	$title = "$FORM{'title'}";
	$filename = "content/support/$title.txt";
	$dropme = `cat $filename`;
	$legal = `cat legal.nsf`;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" background="images/newones/top_tablebg_main.jpg" height="100">
  <tr> 
    <td width="30%"><img src="images/newones/illus_support.jpg" width="250" height="100" border="0"></td>
    <td align="right" valign="middle" width="70%"><font size="1" color="#ffffff" face="verdana,arial,helvetica">$date&nbsp;&nbsp;<font size="3">&nbsp;</font></font>
	<center><img src="images/newones/title_support.jpg" width="350" height="80" align="bottom"></center></td>
  </tr>
</table>
<!-- End header table -->
