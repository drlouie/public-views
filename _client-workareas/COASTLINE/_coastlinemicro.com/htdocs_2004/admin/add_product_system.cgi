...
if (($FORM{'CMPartNum'}) && ($FORM{'CMSeries'})) { 
...
&topper;
	...
	if ($CMSeries eq "GreatWhite") { $LeSeries = "Great White Series&#153; Xeon&#153; Server"; }
	elsif ($CMSeries eq "Mako") { $LeSeries = "Mako Series&#153; Performance Desktop PC"; }
	elsif ($CMSeries eq "Reef") { $LeSeries = "Reef Series&#153; Notebook"; }
	elsif ($CMSeries eq "Thresher") { $LeSeries = "Thresher Series&#153; Value Desktop PC"; }
	else { $LeSeries = "Tiger Series&#153; PIII Server"; }
	if ($ItemName eq "" || $ItemName eq " ") { $SYSName = "$LeSeries - Model $CMPartNum"; }
	else { $SYSName = "$LeSeries - Model $CMPartNum - $ItemName"; }
...
my $sth = $dbh->prepare("INSERT INTO Systems (SystemID, Parent, CMSeries, Reconfig, 
						 ...
						 VALUES (Null, '$CMPartNum', '$CMSeries', '$Reconfig', 
...
my $sth = $dbh->prepare("INSERT INTO Products (ProductID, CMPartNum, 
						 ...
						 VALUES (Null, '$CMPartNum', '$MIOSystemID', Null, Null, Null, Null, 
...
<html>
<head>
<title>Coastline Micro, Inc. - Shark Tank Admin System - Inventory ( Computer Systems )</title>
...
var missingdrop = "";
var thefirst = "";
var formindex = document.add.CMSeries.selectedIndex;
var thisone = document.add.CMSeries.options[formindex].value;

// Check Common form fields
if (thisone == "BIGNULL") {
    missingdrop += "\\n     - That is an invalid option for the Coastline Micro Series...";
	thefirst = "CMSeries";
}
                              ...
                              <td width="270" valign="top"> 
                                <table width="300" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
                                    ...
                                    <td height="20" bgcolor="#8F8FAB"><font face="verdana,arial,helvetica" size="1" color="#333366"><b><font color="#FFFFFF">Coastline Micro Series</font></b></font></td>
                                    <td width="15" height="15" bgcolor="#8F8FAB">&nbsp;</td>
                                  </tr>
                                  <tr> 
                                  ...
                                  <tr> 
                                    ...
                                    <td height="115" bgcolor="#F2F2F7"><font face="verdana,arial,helvetica" size="1" color="#333366">Every configured system must have a Coastline Micro series associated with it. Below you will see the type of computer system you are attempting to add. If this is a Desktop PC or a Server you are attempting to add please make sure you select the correct series from the list. Notebooks will have this information automatically preset for you.</font></td>
                                    <td width="15" bgcolor="#F2F2F7">&nbsp;</td>
                                  </tr>
                                        <tr> 
                                    <td width="15" bgcolor="#F2F2F7">&nbsp;</td>
...
if ($ProductType eq "Desktop") {
	print "<select name=\"CMSeries\" class=\"inputtext\">";
	...
	print "<input type=\"hidden\" name=\"CMSeries\" value=\"Reef\"><font face=\"verdana,arial,helvetica\" size=\"1\" color=\"#EB0000\">Reef Series&#153; Notebook</font>";
}
