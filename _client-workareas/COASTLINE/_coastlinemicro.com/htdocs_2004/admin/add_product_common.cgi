...
if (($FORM{'CMPartNum'}) && ($FORM{'MFGPartNum'}) && ($FORM{'ItemName'}) && ($FORM{'Cost'})) { 
...
## ------------->>> IF EXISTS DIE
		if (($SavedCMPartNum eq "$CMPartNum") || ($SavedMFGPartNum eq "$MFGPartNum")) {
...
my $sth = $dbh->prepare("INSERT INTO Products (ProductID, CMPartNum, 
						 ...
						 VALUES (Null, '$CMPartNum', Null, Null, Null, Null, Null, 
						 '$MFGPartNum', Null, Null, '$PricingClass', '$ItemName', 
