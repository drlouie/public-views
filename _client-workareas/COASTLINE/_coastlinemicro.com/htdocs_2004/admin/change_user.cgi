...
EOF
	...
	print "<center><br><b>Delete User Account</b><br><br>The account for <b>$Username</b> has been deleted from the system effective immediately.<br><br><form><input type=\"button\" value=\"Back to Home\" onClick=\"javascript:parent.location.href='http://www.coastlinemicro.com/admin/index.cgi'\" class=\"inputbut\"><br></center>";
	print "<br><br></font>";
	my $dbh = DBI->connect("DBI:mysql:coastline","drlouie","chinga2") or die "Unable to connect to database: <b>coastline</b>\n"; 
	$dbh->{RaiseError} = 1; 
...
## ------------->>> IF CM USER RUN CM USER RIGHTS
if ($SavedUserAccess =~ "CM") { 

## WHICH UserAccess IS CHOSEN?
@Types = ("CMAdmin","CMManage","CMSales","CMUser");
foreach $Type (@Types) {
...
<form method="post" action="http://www.coastlinemicro.com$script" name="change">
                                ...
                                <td width="348" valign="top"> 
                                  <table width="500" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr> 
                                      ...
                                      <input type="button" value="Create User Account" class="inputbut" onClick="javascript:parent.location.href='http://www.coastlinemicro.com/admin/add_user.cgi'">
                                      </td>
                                      <td width="15" bgcolor="#F2F2F7">&nbsp;</td>
                                    </tr>
                                    <tr> 
                                  ...
                                  <table width="500" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr> 
                                      ...
                                      <td height="280" align="center" width="234" valign="top"> 
                                        <br>
<form method="post" action="http://www.coastlinemicro.com/admin/view_users.cgi">
