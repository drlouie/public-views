...
<html>
<head>
<title>Coastline Micro, Inc. - Shark Tank Admin System - Retrieve Password</title>
<LINK REL="STYLESHEET" HREF="http://www.coastlinemicro.com/Mailbox/commoncss.cgi" Type="text/css">
</head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" background="http://www.coastlinemicro.com/Mailbox/images/top_tablebg_main.jpg" height="100"><tr><td width="30%" valign="top"><img src="http://www.coastlinemicro.com/Mailbox/images/illus_main.jpg" width="250" height="100"></td><td width="25%">&nbsp;</td><td align="left" valign="top"><img src="http://www.coastlinemicro.com/Mailbox/images/title_main.jpg" width="300" height="100"></td></tr></table>
<table width="400" border="0" cellspacing="0" cellpadding="0" align="center"><tr><td width="100%" valign="top"><font face="verdana,arial,helvetica" size="1" color="#333366">$FirstName,<br><br>Here is the Shark Tank&#153; login information for you account as requested. <br><br><b>Username</b> - $Username<br><b>Password</b> - $Pass<br><br>Your account is valid within the Shark Tank&#153; administration system and ECom Store.<br><ul><li>Shark Tank&#153; Administration System<br><a href="http://www.coastlinemicro.com/admin/">http://www.coastlinemicro.com/admin/</a></li><li>Shark Tank&#153; ECom Store<br><a href="http://www.coastlinemicro.com/">http://www.coastlinemicro.com/</a></li><li>Did not request this info?<br><a href="mailto:security\@coastlinemicro.com?Subject=Request Password Fraud (Shark Tank Admin)">Report It</a></li></ul></font></td></tr></table>
...
#	print MAIL "To: $Email\n";
#	print MAIL "From: siteadmin\@coastline-mail.com (Coastline Micro, Inc. - Shark Tank)\n";
#	print MAIL "Subject: Administration System - Retrieve Password\n\n";
#	print MAIL "$FirstName,\n\n";
#	print MAIL "Here is the login information your requested. \n\n";
#	print MAIL "Username - $Username\n";
#	print MAIL "Password - $Pass\n\n";
#	print MAIL "Your account is valid with the Shark Tank administration system and the ECom Store.\n\n";
#	print MAIL "Click here to access the Shark Tank administration system: http://www.coastlinemicro.com/admin/\n\n";
#	print MAIL "Click here to access the ECom Store: http://www.coastlinemicro.com/\n\n";
#	print MAIL "Click here here if you did not request this info: security\@coastlinemicro.com\n\n\n";
#	close (MAIL);
	
## ----------------------->>> SAVE COPY OF EMAIL MESSAGE TO DB
	my $RecipientsIn = "$Email\n";
	my $SubjectIn = "Administration System - Retrieve Password";
	my $BodyIn = "$FirstName,\n\nHere is Shark Tank login information for your account as requested. \n\nUsername - $Username\nPassword - $Pass\n\nYour account is valid within the Shark Tank administration system and ECom Store.\n\nShark Tank administration system: http://www.coastlinemicro.com/admin/\n\nECom Store: http://www.coastlinemicro.com/\n\nDid not request this info?: security\@coastlinemicro.com\n\n\n";
	my $Attach1In = "";
	my $Attach2In = "";
	my $Attach3In = "";
	my $Number = "$TheNumber";
      ...
      <td align="center" width="50%" valign="middle"><img src="images/splash_logos.jpg" width="166" height="164"><br>
        ...
        <table width="350" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td rowspan="6"s><font face="verdana,arial,helvetica" size="1" color="#333366">To retrieve your password please fill out these form fields. All information you input must match the information saved in your user profile. If you have any problems please ask a Coastline Micro supervisor for further assistance.<br></font></td>
          </tr>
          <tr> 
            <td width="135"> 
