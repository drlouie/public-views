...
EOF
	...
	print "<center><br><b>Inventory Updated</b><br><br>The the changes you have made to <b>$ItemName ($CMPartNum)</b> have been successfully saved to the system.<br><br><form><input type=\"button\" value=\"Back to Product: $CMPartNum\" onClick=\"javascript:location.href='change_product_common.cgi?CMPartNum=$CMPartNum'\" class=\"inputbut\"><br><br><input type=\"button\" value=\"View/Add/Update Inventory\" onClick=\"javascript:parent.location.href='change_product.cgi'\" class=\"inputbut\"></form><br></center>";
	print "<br><br></font>";
              ...
              <tr bordercolor="#333366">
                <td width="50%" align="center" valign="top" height="250">
                  <table width="65%" border="0" cellspacing="0" cellpadding="5">
                    <tr>
                      <td width="100%"><font face="verdana,arial,helvetica" size="1" color="#333366">
<br><b>No Matching Records Found</b><ul><li>The Coastline Micro Part Number you specified does not match the Product Type you selected: <b>$PricingClass</b>.</li><li>Are you sure <b>$CMPartNum</b> isn't actually a Kit and not just a stand-alone item?</li></ul><form><center><input type="button" value="Try Again" onClick="javascript:history.go('-1')" class="inputbut"></center><br>
<br><br></font>
                      </td>
                    </tr>
                  </table>
...
<html>
<head>
<title>Coastline Micro, Inc. - Shark Tank Admin System - Inventory ( Stand-Alone Products )</title>
                                  ...
                                  <tr> 
                                    ...
                                    <td align="center" valign="middle" width="100%"> 
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                        <tr> 
                                          <td width="100%" height="25" align="center" bgcolor="#F2F2F7" colspan="2"><font face="verdana,arial,helvetica" size="1" color="#333366"><b>Coastline 
                                            Micro Part Number</b></font></td>
                                        </tr>
                                        <tr> 
                                          <td width="100%" height="35" valign="middle" align="center" colspan="2"> 
                                            <font face="verdana,arial,helvetica" size="1" color="#333366">$CMPartNum</font> 
                                          </td>
                                        </tr>
                                        <tr> 
                                        ...
                                        <tr> 
                                          <td colspan="2" height="25" width="100%" align="center" bgcolor="#F2F2F7"><font face="verdana,arial,helvetica" size="1" color="#333366"><b>Synnex 
                                            Part Number</b></font> </td>
                                        </tr>
                                        <tr> 
                                          <td height="35" width="85%" valign="middle" align="center"> 
                                ...
                                <table width="300" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr> 
                                    ...
                                    <td height="125" align="left"><font face="verdana,arial,helvetica" size="1" color="#333366"><b>Product 
                                      ...
                                      the <b>Manufacturer's</b> website or Coastline 
                                      Micro's website please add that URL here.<br>
                                      <br>
                                      <center>
                                  ...
                                  <tr> 
                                    ...
                                    <td height="125" align="left"><font face="verdana,arial,helvetica" size="1" color="#333366"><b>Driver 
                                      ...
                                      or Coastline Micro's website please add 
                                      that URL here.<br>
                                      <br>
                                      <center>
