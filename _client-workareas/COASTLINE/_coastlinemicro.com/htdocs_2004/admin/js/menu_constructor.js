...
if (b=="Netscape") {
	topFrame = parent.frames.topOne;
	botFrame = parent.frames.botOne;
	myProfile = topFrame.document.forms(0).ME.value;
	botFrame.location.href = myProfile;
	}

else {
	myProfile = parent.topOne.document.forms(0).ME.value;
	parent.botOne.location.href = myProfile;
	}
}
...
*/
oCMenu.makeMenu('top0','','<font class=\"menu1\">System Customer Base</font><img src=\"http://www.coastlinemicro.com/images/spacer.gif\" border=\"0\" height=\"8\" width=\"10\"><img src=\"http://www.coastlinemicro.com/images/newmenu/arrow.gif\" border=\"0\" height=\"8\" width=\"5\">','','',0,0,'','')
	oCMenu.makeMenu('sub00','top0','<font class=\"menu2\">View/Add/Update</font>','http://www.coastlinemicro.com/admin/change_customer.cgi','parent',0,0,'','')

oCMenu.makeMenu('top1','','<font class=\"menu1\">Shark Tank&#153; Users</font><img src=\"http://www.coastlinemicro.com/images/spacer.gif\" border=\"0\" height=\"8\" width=\"33\"><img src=\"http://www.coastlinemicro.com/images/newmenu/arrow.gif\" border=\"0\" height=\"8\" width=\"5\">','','',0,0,'','')
	oCMenu.makeMenu('sub01','top1','<font class=\"menu2\">My Account</font>','','',0,0,'','','','','','','myProfile();')
	oCMenu.makeMenu('sub02','top1','<font class=\"menu2\">View/Add/Update</font>','http://www.coastlinemicro.com/admin/change_user.cgi','parent',0,0,'','')
	
oCMenu.makeMenu('top2','','<font class=\"menu1\">Order Tracking</font><img src=\"http://www.coastlinemicro.com/images/spacer.gif\" border=\"0\" height=\"8\" width=\"61\"><img src=\"http://www.coastlinemicro.com/images/newmenu/arrow.gif\" border=\"0\" height=\"8\" width=\"5\">','','',0,0,'','')
	oCMenu.makeMenu('sub03','top2','<font class=\"menu2\">UPS Shipping Calculator</font>','http://www.coastlinemicro.com/admin/ups_shipping.cgi','parent',0,0,'','')
	oCMenu.makeMenu('sub04','top2','<font class=\"menu2\">UPS Package Tracking</font>','http://www.coastlinemicro.com/admin/ups_tracking.cgi','parent',0,0,'','')
	
oCMenu.makeMenu('top3','','<font class=\"menu1\">Product Inventory</font><img src=\"http://www.coastlinemicro.com/images/spacer.gif\" border=\"0\" height=\"8\" width=\"40\"><img src=\"http://www.coastlinemicro.com/images/newmenu/arrow.gif\" border=\"0\" height=\"8\" width=\"5\">','','',0,0,'','')
	oCMenu.makeMenu('sub05','top3','<font class=\"menu2\">View/Add/Update Inventory</font>','http://www.coastlinemicro.com/admin/change_product.cgi','parent',0,0,'','')
	oCMenu.makeMenu('sub06','top3','<font class=\"menu2\">View/Add/Update MFGs</font>','http://www.coastlinemicro.com/admin/change_mfg.cgi','parent',0,0,'','')
	oCMenu.makeMenu('sub07','top3','<font class=\"menu2\">View/Add/Update DISTs</font>','http://www.coastlinemicro.com/admin/change_dist.cgi','parent',0,0,'','')

oCMenu.makeMenu('top4','','<font class=\"menu1\">Other Dynamics</font><img src=\"http://www.coastlinemicro.com/images/spacer.gif\" border=\"0\" height=\"8\" width=\"56\"><img src=\"http://www.coastlinemicro.com/images/newmenu/arrow.gif\" border=\"0\" height=\"8\" width=\"5\">','','',0,0,'','')	
	oCMenu.makeMenu('sub08','top4','<font class=\"menu2\">Press Release Articles</font>','http://www.coastlinemicro.com/admin/press.cgi','parent',0,0,'','')
	oCMenu.makeMenu('sub09','top4','<font class=\"menu2\">QISV</font>','http://www.coastlinemicro.com/admin/qisv.cgi','parent',0,0,'','')	
	oCMenu.makeMenu('sub10','top4','<font class=\"menu2\">Website Copy</font>','http://www.coastlinemicro.com/admin/change_copy.cgi','parent',0,0,'','')
