...
<script language="Javascript">
function iPreview() {
window.open('http://www.coastlinemicro.com/dbimages/$Type/$real_name','PREVIEW','width=400,height=400');
}
</script>
</head>
...
<input type="hidden" name="OuterURL" value="http://www.coastlinemicro.com/dbimages/$Type/$real_name">
