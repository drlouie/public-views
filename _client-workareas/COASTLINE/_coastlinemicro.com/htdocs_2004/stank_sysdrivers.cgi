	...
	if ($Character eq "All" && $Parties =~ ",") {
		...
		foreach $SubPart (@SubParts) {
			...
			while(@row = $sth->fetchrow_array) {
				...
				if ($MFGDriverURL ne "" && $MFGDriverURL ne " " && $MFGDriverURL ne "None" && $MFGDriverURL ne "NONE" && $MFGDriverURL ne "none") { push(@MuaDrivers,"$Category,,,,,$MuaCMNum,,,,,$MFGPartNum,,,,,$MFGProdURL,,,,,$MFGDriverURL,,,,,$MuaName"); }
			}
			$sth->finish;
		}
	}
...
function printPage() {
  if (ns4) // NS4
    window.open('stank_sysdrivers.html?CMPartNum=$CMPartNum&NSPRINT=1','PRINT','width=485,height=590');
  else if (pr) // IE5+
    window.print()
  else if (ns6) // NS6
    ...
    <td align="center" valign="middle" width="$tablewidth" height="25"> 
      <table width="$tablewidth" border="0" cellspacing="0" cellpadding="0" background="images/tables/topbar.jpg" height="24">
        <tr> 
          ...
          <td width="$t4" align="center" valign="top"><a href="javascript:void(0);" onClick="javascript:printPage('stank_sysdrivers.html','CMPartNum','$CMPartNum');" onMouseOver="javascript:imageOnDHTML('printit','ov');" onMouseOut="javascript:imageOffDHTML('printit','off');"><img src="images/tables/but_printit_off.gif" width="67" height="21" name="printit" border="0"></a></td>
    ...
    <td align="center"> 
      <table width="$tablewidth" border="0" cellspacing="0" cellpadding="0" height="30">
        <tr align="center"> 
          ...
          <td width="16%"><a href="javascript:trigger('stank_techspecs.html?CMPartNum=$CMPartNum&ComingFrom=$ComingFrom');" onMouseOver="javascript:imageOnDHTML('techspecs','ov');" onMouseOut="javascript:imageOffDHTML('techspecs','off');"><img src="images/tables/but_techspecs_off.gif" width="77" height="20" name="techspecs" border="0"></a></td>
              ...
              <tr> 
                <td> 
                  <table width="100%" cellspacing="0" cellpadding="0" bgcolor="#F2F2F7" class="stankth" height="18" $border>
                    <tr> 
                      <td align="center"><font class="btext"><b>System Driver Locations</b></font></td>
                    </tr>
                  </table>
                </td>
              </tr>
...
$MuaCount=0;
foreach $MuaDriver (@MuaDrivers) {
		@ThisDriver = split(/,,,,,/, $MuaDriver);
		$MuaCate = $ThisDriver[0];
		$MuaCMNum = $ThisDriver[1];
		$MuaMFGNum = $ThisDriver[2];
		$MuaMFGProd = $ThisDriver[3];
		$MuaMFGDriv = $ThisDriver[4];
		$MuaName = $ThisDriver[5];
		if ($LastMuaCate eq "$MuaCate") { $MuaCategory = ""; }
		elsif ($MuaCount eq "0") { $MuaCategory = "<center><b>$MuaCate</b></center>"; }
		else { $MuaCategory = "<center><br><b>$MuaCate</b></center>"; }
		$LastMuaCate = "$MuaCate";

		if ($MuaMFGProd eq "") { $MuaMFGProducto = "<font class=\"btext\">Product Info</font>"; }
		else { $MuaMFGProducto = "<font class=\"btext\"><a href=\"javascript:abrete('$MuaMFGProd');\">Product Info</a></font>"; }		
		if ($MuaMFGDriv eq "") { $MuaMFGDriver = "<font class=\"btext\">Driver Update</font>"; }
		else { $MuaMFGDriver = "<font class=\"btext\"><a href=\"javascript:abrete('$MuaMFGDriv');\">Driver Update</a></font>"; }		
...
<font class="btext3">$MuaCategory</font>
<table width="75%" border="0" cellspacing="0" cellpadding="2" align="center" bordercolor="#FFFFFF">
<tr valign="middle" bgcolor="#F2F2F7">
<td width="5%"><font size="-4">&nbsp;</font></td>
<td width="60%" align="left">
<font class="btext3">$MuaName</font>
</td>
<td width="5%"><font size="-4">&nbsp;</font></td>
<td height="10" width="30%">

<table border="1" cellspacing="0" cellpadding="3" bordercolor="#FFFFFF" align="center" width="100%" bgcolor="#F2F2F7">
<tr align="center"><td width="100%" height="12">$MuaMFGProducto</td></tr>
<tr align="center"><td width="100%" height="12">$MuaMFGDriver</td></tr>
</table>
...
if ($MuaCount eq "0") { print "<div class=\"btext3\" style=\"margin-left:20px;margin-right:20px;\">No updated system drivers are available at this time. Please remember to bookmark this page and check back regularly for updated system drivers.</div>"; }
