...
if ($FORM{'lasturl'}) {
	if ($FORM{'CID'}) { $muaURL = "http://www.coastlinemicro.com/$FORM{'lasturl'}?CID=$FORM{'CID'}"; }
	else { $muaURL = "http://www.coastlinemicro.com/$FORM{'lasturl'}"; }
}
else {
	$muaURL = "http://www.coastlinemicro.com/ss.html";
}
...
<html>
<head>
<title>Coastline Micro, Inc. - Shark Tank Login</title>
...
<form method="post" name="login" action="https://www.coastlinemicro.com/login.html" onSubmit="return checkForm();">
        ...
        <table width="350" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td rowspan="4"><font face="verdana,arial,helvetica" size="1" color="#333366">To 
              access the Shark Tank, our E-Commerce Store, you must first login. 
