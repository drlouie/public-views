...
## ----------------------->>> SEND EMAIL MESSAGE
    ...
    use MIME::Lite;
        my $msg = MIME::Lite->new(
                     From    =>$SenderIn,
                     To      =>$Email,
                     Subject =>'Shark Tank&#153; System - Retrieve Password',
...
<html>
<head>
<title>Coastline Micro, Inc. - Shark Tank - Retrieve Password</title>
<LINK REL="STYLESHEET" HREF="http://www.coastlinemicro.com/Mailbox/commoncss.html" Type="text/css">
<STYLE TYPE="text/css">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" background="http://www.coastlinemicro.com/Mailbox/images/top_tablebg_main.jpg" height="100"><tr><td width="30%" valign="top"><img src="http://www.coastlinemicro.com/Mailbox/images/illus_main.jpg" width="250" height="100"></td><td width="25%">&nbsp;</td><td align="left" valign="top">&nbsp;</td></tr></table>
<table width="400" border="0" cellspacing="0" cellpadding="0" align="center"><tr><td width="100%" valign="top"><font face="verdana,arial,helvetica" size="1" color="#333366">$FirstName,<br><br>Here is your Shark Tank&#153; login information as you requested. The Shark Tank is Coastline Micro's Interactive E-Com Store which features a fully functional System Configurator.<br><br><b>Username</b> - $Username<br><b>Password</b> - $Pass<br><br>Your account is valid ONLY within the Shark Tank&#153;, our Interactive E-Com Store.<br><ul><li>Shark Tank&#153; System<br><a href="http://www.coastlinemicro.com/">http://www.coastlinemicro.com/</a></li><li>Did not request this info?<br><a href="mailto:security\@coastlinemicro.com?Subject=Request Password Fraud (Shark Tank)">Report It</a></li></ul></font></td></tr></table>
...
## ----------------------->>> SAVE COPY OF EMAIL MESSAGE TO DB
	...
	my $sth = $dbh->prepare("INSERT INTO Messages (MessageID, Username, QuoteID, OrderID, ConfigID, 
						 	...
						 	VALUES (Null, 'SharkTank', '', '', '', '$SenderIn', 
...
<html>
<head>
<title>Coastline Micro, Inc. - Shark Tank System Login - Retrieve Password</title>
      ...
      <td align="center" width="50%" valign="middle"><img src="images/splash_logos.jpg" width="166" height="164"><br>
        ...
        <table width="350" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td rowspan="6"s><font face="verdana,arial,helvetica" size="1" color="#333366">To retrieve your password please fill out these form fields. All information you input must match the information saved in your user profile. If you have any problems please ask a Coastline Micro Representative for further assistance.<br></font></td>
          </tr>
          <tr> 
            <td width="135"> 
          ...
          <tr align="center"> 
			...
			<a href="#"  tabIndex="5" onClick="Javascript:document.location.reload();" onMouseOver="javascript:imageOn('reset','on');" onMouseOut="javascript:imageOff('reset','off');"><img src="images/login/reset_off.gif" name="reset" width="88" height="19" border="0"></a>
			</td>
          </tr>
        </table>
    </td>
  ...
  <tr>
    <td width="25%">&nbsp;</td>
      <td align="center" width="50%" valign="middle"><img src="images/splash_logos.jpg" width="166" height="164"><br>
        ...
        <table width="350" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="100%"><font face="verdana,arial,helvetica" size="1" color="#333366">Your login information has been sent to your email address. Please check your email and try logging back into the system again.<br><br>If you have any further problems please ask a Coastline Micro supervisor for assistance.</font></td>
          </tr>
        </table>
    </td>
      <td width="25%">&nbsp;</td>
      ...
      <td align="center" width="50%" valign="middle"><img src="images/splash_logos.jpg" width="166" height="164"><br>
        ...
        <table width="350" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td rowspan="6" bgcolor="#8F8FAB" width="1"><img src="images/verticalbar.gif" width="1" height="25"></td>
            <td width="15" bgcolor="#FFFFFF">&nbsp;</td>
            <td rowspan="6"s><font face="verdana,arial,helvetica" size="1" color="#333366"><font color="red">*</font>Sorry, no accounts match the information you submitted, please try again.<br><br>All information you input must match the information saved in your user profile. If you have any problems please ask a Coastline Micro supervisor for further assistance.<br></font></td>
          </tr>
          <tr> 
            <td width="135"> 
