...
foldinImg=new Image(); foldinImg.src="images/ovallarge_off.gif"		//The image for the closed state.
foldoutImg=new Image(); foldoutImg.src="images/ovallarge_on.gif"	//The image for the open state.
//Here are the images for the sub links.
foldsubinImg=new Image(); foldsubinImg.src="images/ovalsmall_off.gif"		//The image for the "in" state.
foldsuboutImg=new Image(); foldsuboutImg.src="images/ovalsmall_on.gif"	//The image for the "out" state.
//If you change the images above please remember to change the images in the actual page as well.

mainmenus=%%TotalMainMenuCount%% //How many main menus do you have?

//How many submenus do you have beneath each main level.
//submenus=new Array(3,3,2,3)
submenus=new Array(%%SubMenuArray%%)
