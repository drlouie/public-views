...
if ($mls_pass == $admin_password) {
	...
	$resultID = mysql_query("SELECT mls, realtor_user_name, realtor_name ,realtor_phone ,realtor_email ,title ,short_description ,detailed_description ,price ,status ,bedrooms ,baths ,half_baths ,sqf ,acres ,house_type ,image1 ,image2 ,image3 ,image4 ,image5 ,image6 ,image7 ,image8 ,image9 ,image10 ,url ,virtual_tour ,map ,property_address ,property_city ,property_state ,property_zip ,property_county ,property_school_zone , feature1, feature2, feature3, feature4, feature5, feature6, feature7, feature8, feature9, feature10, feature11, feature12, feature13, feature14, feature15, feature16,feature17,feature18,feature19,feature20,feature21,feature22,feature23,feature24,feature25,feature26,feature27,feature28,feature29,feature30,feature31,feature32,feature33,feature34,feature35,feature36,feature37,feature38,feature39,feature40 FROM user_mls", $linkID);
...
<form action=admin_edit_save.php method=post enctype=\"multipart/form-data\">
<input type=hidden name=image1 value=\"$row[image1]\">
<input type=hidden name=image2 value=\"$row[image2]\">
<input type=hidden name=image3 value=\"$row[image3]\">
<input type=hidden name=image4 value=\"$row[image4]\">
<input type=hidden name=image5 value=\"$row[image5]\">
<input type=hidden name=image6 value=\"$row[image6]\">
<input type=hidden name=image7 value=\"$row[image7]\">
<input type=hidden name=image8 value=\"$row[image8]\">
<input type=hidden name=image9 value=\"$row[image9]\">
<input type=hidden name=image10 value=\"$row[image10]\">
<input type=hidden name=uname value=\"$uname\">
<input type=hidden name=upass value=\"$upass\">
<input type=hidden name=realtor_user_name value=\"$row[realtor_user_name]\">
<div align=\"center\">
  <center>
...
\n";
	...
	if ($action_type == "delete") {
		...
		$linkID = @mysql_connect("$server", "$username", "$password");
		mysql_select_db("$database", $linkID);
		$result = mysql_query("DELETE FROM user_mls WHERE 1 AND realtor_user_name = '$uname' AND mls = '$mls'", $linkID);

		if ($result == TRUE) {
			print "<center><b>User Listings were deleted.</b><br><a href=admin.php>Home</a></center>\n";
		} else {
