...
if ($mls_pass == $admin_password) {
	...
	PRINT "<center><form action=admin_header2.php method=post>
	<textarea rows=\"20\" name=\"header\" cols=\"90\">\n";
	$filePointer = fopen("header.inc", "r");
	while (!feof($filePointer)) {
		$line = fgets($filePointer, 4096);
		print $line;
	}
	fclose($filePointer);
	print "</textarea><br><input type=submit value=\"Save Header\"></center></form><br><br>\n";
