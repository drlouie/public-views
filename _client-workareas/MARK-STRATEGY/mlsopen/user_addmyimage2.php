...
if ($remove == "remove") {
print "<br><center><b>Remove MyImage</b></center>\n";

	$linkID = @mysql_connect("$server", "$username", "$password");
	mysql_select_db("$database", $linkID);

$result = mysql_query("UPDATE user_mls SET myimage = '$uploadedFile_name[0]' WHERE 1 AND `mls` = '$mls' AND `realtor_user_name` = '$uname'" ,  $linkID);
...
if ($result == TRUE) {
	...
	print "<br><center><b>Add / Update MyImage</b></center>\n";
