...
<script runat="server">
    ...
    Sub Run_Launch_Sequence
        ...
        try
			...
			oCom.CommandText = "INSERT INTO LMSLeadAssignees ( LeadNumber, UserID, UserTypeID, CreationDate) VALUES (" & LeadNumber & ", " & EndUserID & ", 6, GETDATE())"
			oCom.ExecuteNonQuery()

			oCom.CommandText = "	INSERT INTO LMSStatusAuditTbl (LeadNumber, CreationDate, StatusChangedFrom, StatusChangedTo, ChangedBy, UserTypeID) VALUES (" & LeadNumber & ", GETDATE(), 39, 48, " & CallCUID & ", 6) "
			oCom.ExecuteNonQuery()

			oCom.CommandText = "	INSERT INTO LMSStatusAuditTbl (LeadNumber, CreationDate, StatusChangedTo, StatusChangedTo, ChangedBy, UserTypeID) VALUES (" & LeadNumber & ", GETDATE(), 48, 38, " & CallCUID & ", 6) " & _
