...
$name_list = "Americor Lending Newsletter";
	# THE NAME OF YOUR MAILING LIST

$your_email = "crackrat\@attbi.com";
	# YOUR EMAIL ADDRESS
	# don't forget the \ before @

$your_name = "Americor Lending";
	# YOUR NAME 
	# Will show up in the from field 
	# of all emails sent
	
$name_url ="http://americorlending.com";
	#THE URL OF YOUR SITE

$name_home = "Americor Lending Group";
...
if (!$password) {
	...
	<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>Set Admin Password
	</B></FONT>
	</TD></TR>
	<TR bgcolor="$table_body_bg">
	<TD>
	<BR>
	<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_body_text">
...
<TR bgcolor="$table_head_bg"><TD>
<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>Add or remove an email address
</FONT>
</TD></TR>
<TR bgcolor="$table_body_bg">
<TD>
...
<table cellspacing=0 border=1 cellpadding =5 width=400>
<TR bgcolor="$table_head_bg"><TD>
<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>Admin Functions
</FONT>
</TD></TR>
<TR bgcolor="$table_body_bg">
<TD>
...
<BR><BR>
<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_body_text">Enter admin password<BR><i>Needed for both of above</I></FONT>
<BR>
...
unless ($INPUT{'passad'} eq $INPUT{'passad2'}) {
	...
	<table cellspacing=0 border=1 cellpadding =5 width=400>
	<TR bgcolor="$table_head_bg"><TD>
	<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>Error!!
	</FONT>
	</TD></TR>
	<TR bgcolor="$table_body_bg">
	<TD><FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_body_text">
...
if ($INPUT{'passad'}) {
	...
	<TR bgcolor="$table_body_bg">
	<TD>
	<BR><FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_body_text">
...
<table cellspacing=0 border=1 cellpadding =5 width=400>
<TR bgcolor="$table_head_bg"><TD>
<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>Password Set
</B></FONT>
</TD></TR>
<TR bgcolor="$table_body_bg">
<TD><FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_body_text">
...
<table cellspacing=0 border=1 cellpadding =5 width=400>
<TR bgcolor="$table_head_bg"><TD>
<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>Email successfully added!!
</B></FONT>
</TD></TR>
<TR bgcolor="$table_body_bg">
<TD>
...
<table cellspacing=0 border=1 cellpadding =5 width=400>
<TR bgcolor="$table_head_bg"><TD>
<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>Email successfully removed
</B></FONT>
</TD></TR>
<TR bgcolor="$table_body_bg">
<TD>
...
if ($pid) {
	...
	<table cellspacing=0 border=1 cellpadding =5 width=400>
	<TR bgcolor="$table_head_bg"><TD>
	<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>Email successfully sent!!
	</B></FONT><BR><BR>
	</TD></TR>
	<TR bgcolor="$table_body_bg">
	<TD>
...
<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>Select email to delete
</B></FONT>
</TD></TR>
<TR bgcolor="$table_body_bg">
~;
...
foreach $line(@addresses) {
	...
	print "<TD><FONT SIZE=\"1\" FACE=\"Verdana, Arial, Helvetica, sans-serif\" color=\"$table_body_text\">";
...
<table cellspacing=0 border=1 cellpadding =5 width=400>
<TR bgcolor="$table_head_bg"><TD>
<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>Emails Removed
</B></FONT>
</TD></TR>
<TR bgcolor="$table_body_bg">
<TD><FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_body_text">The following emails have been deleted from the database<BR><BR>
...
<table cellspacing=0 border=1 cellpadding =5 width=400>
<TR bgcolor="$table_head_bg"><TD colspan=3>
<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>Create email to send to all users
</B></FONT>
</TD></TR>
<TR bgcolor="$table_body_bg">
<TD>
...
<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>
$name_list
</FONT>
</TD></TR></TABLE>
<BR><BR>
...
<table cellspacing=0 border=1 cellpadding =5>
<TR bgcolor="$table_head_bg"><TD colspan=3>
<FONT SIZE="1" FACE="Verdana, Arial, Helvetica, sans-serif" color="$table_head_text"><B>Fatal Error!!
</B></FONT>
</TD></TR>
<TR bgcolor="$table_body_bg">
<TD>
