/*
   Milonic DHTML Menu - Menu Editing API Module mm_menueditapi.js version 3.4 - October 31 2006
...
Syntax:
     ...
     mm_createNewMenus()                                        -- mm_createNewMenus()
          mm_cloneMenu("Menu Name To Copy",copyItems)           -- mm_cloneMenu("Main Menu",0);
...
mm_changeStyle(menuRef,style)                                   -- mm_changeStyle("Main Menu",xpMenuStyle)
...
function mm_changeStyle(menuRef,style)
{
