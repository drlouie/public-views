...
function enableAdminform(theForm){
	theForm.PID.disabled = false ;
	theForm.TPAID.disabled = false ;
	theForm.purchaserName.disabled = false ;
	theForm.administrativeSystem.disabled = false ;
	theForm.administrator.disabled = false ;
	theForm.billingFrequency.disabled = false;
	theForm.effDate.disabled = false;
     }
function beforeSaveAdmin(theForm)
{
enableAdminform(theForm);
if(validatePID(theForm) ){
theForm.SelectedAction.value = "Save";
parent.tops.PurTop.PID.value = parent.display.AdministrativeArrgmt.PID.value;
parent.tops.PurTop.TPAID.value = parent.display.AdministrativeArrgmt.TPAID.value;
parent.tops.PurTop.PurName.value = parent.display.AdministrativeArrgmt.purchaserName.value;
