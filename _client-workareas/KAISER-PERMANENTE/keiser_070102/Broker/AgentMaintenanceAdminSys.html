...
<Script language="JavaScript">
   ...
   function setTitle() {
	...
	if ( parent.BrokerMain.document.forms[0] != undefined )
		setTimeout('parent.LeftNav.upTitle(0)',2000);
   	}
...
<FRAMESET rows="375,*" FRAMESPACING="0" frameborder="1" border="3">
  <FRAME name="BrokerMain" src="AgentMaintenance.jsp" OnFocus="setTitle()" noresize scrolling="No" marginheight="0" marginwidth="0" TOPMARGIN="0">
