...
var errorFields ="";
  ...
  if(theForm.FName.value == "")
   ...
   {
	checkInitialSetup(theForm.FName.name,theForm.FName.value);
   }
  if(theForm.LName.value == "")
   ...
   {
	checkInitialSetup(theForm.LName.name,theForm.LName.value);
   }  
...
if(theForm.Honor.value != "")
   {
	checkInitialSetup(theForm.Honor.name,theForm.Honor.value);
   }
if(theForm.MName.value != "")
   {
	checkInitialSetup(theForm.MName.name,theForm.MName.value);
   }
if(theForm.Suffix.value != "")
   {
	checkInitialSetup(theForm.Suffix.name,theForm.Suffix.value);
   }
if(theForm.Title.value != "")
   {
	checkInitialSetup(theForm.Title.name,theForm.Title.value);
   }
if(theForm.FamiliarName.value != "")
   {
	checkInitialSetup(theForm.FamiliarName.name,theForm.FamiliarName.value);
   }
