...
function init()
  {		
	...
	document.AgentMaintenance.BroadcastMedium.value = '<%=brokerVO.getBroadcastMedium()%>';
	document.AgentMaintenance.BusinessType.value = '<%=brokerVO.getBusinessType()%>';
	document.AgentMaintenance.Country.value = '<%=addressVO.getCountry()%>';
...
function resetForm()
{
	...
	document.AgentMaintenance.Country.value = '<%=addressVO.getCountry()%>';
	document.AgentMaintenance.BrokerCategory.value = category[0];
	document.AgentMaintenance.State.value = '<%=addressVO.getState()%>';
...
function enableAll(form)	//Enabling all the Fields when Edit clicked
 {
   ...
   for ( var i = 0 ; i <totalElements ; i++)
    {	
	if(document.AgentMaintenance.elements[i].name != "bid" && document.AgentMaintenance.elements[i].name != "StatusDate" && document.AgentMaintenance.elements[i].name != "changeType"  && document.AgentMaintenance.elements[i].type != "button" && document.AgentMaintenance.elements[i].type != "submit")
		{	
...
function printFunction() {
   ...
   function callExit() {
	...
	function hideIT() {
		...
		var leTotal = document.AgentMaintenance.elements.length;
		for ( var i = 0 ; i <leTotal ; i++) {
			document.AgentMaintenance.elements[i].style.visibility = 'visible';
		}
      ...
      <td width="300" align="right"> 
        <table width="300" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <td height="37" width="398" align="center"><a href="#" OnMouseOver="javascript:msearch.src = image5.src;" OnMouseOut="javascript:msearch.src = image6.src;" OnClick="callSearch()"><img src="limages/msearch_off.gif" width="52" height="37" name="msearch" border="0"></a><input type="image" name="submit" src="limages/msave_off.gif" width="52" height="37" border="0"><a href="#" OnMouseOver="javascript:mprint.src = image9.src;" OnMouseOut="javascript:mprint.src = image10.src;" OnClick="printFunction();"><img src="limages/mprint_off.gif" width="52" height="37" name="mprint" border="0"></a> 
        ...
        <table width="125" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <td height="20" width="198" align="center"> 
              <INPUT type="radio" checked name="changeType" value="agent"><FONT class="radiotext">Agent</FONT>
              <INPUT type="radio" name="changeType" value="firm" onClick="callBrokerTypeChange()"><FONT class="radiotext">Firm</FONT>
</td>
            <td width="1" bgcolor="#E6E9F0"><img src="limages/spacer.gif" border="0" width="1" height="1"></td>
          </tr>
          <tr> 
      ...
      <td colspan="3" valign="top"> 
        <table width="840" border="0" cellspacing="0" cellpadding="1">
          <tr align="center"> 
            ...
            <td width="75"><font class="ComTitle"><font style="color:#eb0000;font-size:11px">*</font>Tax ID</font></td>
          ...
          <tr align="left" valign="middle" bgcolor="#E6E9F0"> 
            <td width="48" align="center"><input size="6" type="text" maxlength="12" name="bid" onFocus="this.blur()" value="<%=brokerVO.getBID()%>" class="input1"></td>
            <td width="75" align="center"> 
              <input size="11" type="text" maxlength="9" name="TaxID" onFocus="this.blur()" value="<%=brokerVO.getTaxID()%>" class="input1" tabindex="1">
            </td>
...
<%
		...
		%>
            ...
            <td width="71" align="center"> 
              <input size="11" type="text" maxlength="10" name="StatusDate" value="<%=statusVO.getStatusDate()%>" onFocus="this.blur()" class="input1">
            </td>
            <td width="154">&nbsp;</td>
      ...
      <td colspan="3" valign="top"> 
        <table width="790" border="0" cellspacing="0" cellpadding="1">
          <tr align="center"> 
            ...
            <td><font class="ComTitle"><font style="color:#eb0000;font-size:11px">*</font>First Name</font></td>
            <td><font class="ComTitle">Middle Name</font></td>
            <td><font class="ComTitle"><font style="color:#eb0000;font-size:11px">*</font>Last Name</font></td>
            <td><font class="ComTitle">Suffix</font></td>
            <td><font class="ComTitle">Title</font></td>
            <td><font class="ComTitle">Familiar Name</font></td>
            <td><font class="ComTitle"><font style="color:#eb0000;font-size:11px">*</font>Business Type</font></td>
          </tr>
          <tr align="center" bgcolor="#E6E9F0"> 
            <td> 
              <input size="5" type="text" maxlength="10" name="Honor" onFocus="this.blur()" class="input1" value="<%=agentVO.getHonor()%>" tabindex="2">
            </td>
            <td> 
              <input size="20" type="text" maxlength="25" name="FName" onFocus="this.blur()" value="<%=agentVO.getFirstName()%>" class="input1" tabindex="3">
            </td>
            <td> 
              <input size="15" type="text" maxlength="25" name="MName" onFocus="this.blur()" value="<%=agentVO.getMiddleName()%>" class="input1" tabindex="4">
            </td>
            <td> 
              <input size="20" type="text" maxlength="25" name="LName" onFocus="this.blur()" value="<%=agentVO.getLastName()%>" class="input1" tabindex="5">
            </td>
            <td> 
              <input size="10" type="text" maxlength="20" name="Suffix" onFocus="this.blur()" value="<%=agentVO.getSuffix()%>" class="input1" tabindex="6">
            </td>
            <td> 
              <input size="15" type="text" maxlength="20" name="Title" onFocus="this.blur()" class="input1" value="<%=agentVO.getTitle()%>" tabindex="7">
            </td>
            <td> 
              <input size="15" type="text" maxlength="20" name="FamiliarName" onFocus="this.blur()" class="input1" value="<%=agentVO.getFamiliarName()%>" tabindex="8">
            </td>
            <td> 
                    ...
                    <table width="353" border="0" cellspacing="0" cellpadding="2">
                      <tr valign="bottom"> 
                        <td align="center" width="176" valign="middle" height="27"><font class="ComTitle">Eff 
                          Date</font> 
                          <input size="11" type="text" maxlength="10" name="EffDate" onFocus="this.blur()" value="<%=addressVO.getEffectiveDate()%>" class="input1" onKeyPress="checkEffDateChanged()" tabindex="9">
                        ...
                        <td align="left" colspan="3" valign="middle"> 
                          <input size="11" type="text" maxlength="10" name="MailStop" onFocus="this.blur()" value="<%=addressVO.getMailStop()%>" class="input1" onKeyPress="checkEffDateChanged()" tabindex="11">
                        </td>
                      </tr>
                      <tr valign="bottom"> 
                        <td align="right" width="176" height="27"><nobr><font class="ComTitle"><font style="color:#eb0000;font-size:11px">*</font>Line 1</font>&nbsp; 
                          <input size="20" type="text" maxlength="50" name="Line1" onFocus="this.blur()" value="<%=addressVO.getLine1()%>" class="input1" tabindex="10">
                          </nobr> </td>
                        ...
                        <td width="52" height="27"> 
                          <input size="5" type="text" maxlength="10" name="Zip" onFocus="this.blur()" value="<%=addressVO.getZip()%>" class="input1" onKeyPress="checkEffDateChanged()" tabindex="16">
                        </td>
                      </tr>
                      <tr valign="bottom"> 
                        <td align="right" width="176"><nobr><font class="ComTitle">Line 
                          2</font>&nbsp; 
                          <input size="20" type="text" maxlength="50" name="Line2" onFocus="this.blur()" value="<%=addressVO.getLine2()%>" class="input1" tabindex="12">
                          </nobr></td>
                        <td width="75" align="right"><font class="ComTitle">County</font></td>
                        <td width="187" colspan="3"> 
                          <input size="20" type="text" maxlength="20" name="County" onFocus="this.blur()" value="<%=addressVO.getCounty()%>" class="input1" tabindex="17">
                        </td>
                      </tr>
                      <tr valign="bottom"> 
                        <td align="right" width="176"><nobr><font class="ComTitle">Line 
                          3</font>&nbsp; 
                          <input size="20" type="text" maxlength="50" name="Line3" onFocus="this.blur()" class="input1" value="<%=addressVO.getLine3()%>" tabindex="13">
                          </nobr> </td>
		...
		%>
                      ...
                      <tr valign="bottom"> 
                        <td align="right" width="176"><nobr><font class="ComTitle"><font style="color:#eb0000;font-size:11px">*</font>City</font>&nbsp; 
                          <input size="20" type="text" maxlength="25" name="City" onFocus="this.blur()" value="<%=addressVO.getCity()%>" class="input1" tabindex="14">
                          </nobr> </td>
                        <td width="75" align="right"><font class="ComTitle">Province</font></td>
                        <td width="187" colspan="3"> 
                          <input size="20" type="text" maxlength="20" name="Province" onFocus="this.blur()" class="input1" value="<%=addressVO.getProvince()%>" tabindex="19">
                  ...
                  <td width="373" align="center"> 
                    <table width="373" border="0" cellspacing="0" cellpadding="2">
                      ...
                      <tr align="center" valign="middle" bgcolor="#E6E9F0"> 
                        <td width="120"> 
                          <input size="20" type="text" maxlength="40" name="EMail" value="<%=brokerVO.getEMailAddress()%>" class="input1" onFocus="this.blur()" onChange="checkForFaxInPhoneList()" tabindex="21">
                        </td>
                        <td width="120"> 
                          <input size="20" type="text" maxlength="40" name="WebURL" value="<%=brokerVO.getWebURL()%>" class="input1" onFocus="this.blur()" tabindex="22">
                        </td>
                        <td width="133"> 
				...
				for(int i = 0 ; i < phnTypeText.size(); i++) {
	               ...
	               <%
				       ...
				       %>
                        ...
                        <td width="178" align="center" bgcolor="#E6E9F0"><a href="#" tabindex="29" onClick="addToList(document.AgentMaintenance);" OnMouseOver="javascript:add.src = image15.src;" OnMouseOut="javascript:add.src = image16.src;"><img src="limages/add_off.gif" width="50" height="19" border="0" alt="Add" name="add"></a> 
			...
			<INPUT type="hidden" name="PreviousBrdcst">
                      ...
                      <tr align="center" valign="bottom"> 
                        <td colspan="7" height="30"><a href="#" onClick="deleteFromList(document.AgentMaintenance);" OnMouseOver="javascript:delsel.src = image17.src;" OnMouseOut="javascript:delsel.src = image18.src;"><img src="limages/delsel_off.gif" width="138" height="19" border="0" alt="Delete Selected" name="delsel" vspace="0"></a> 
                        </td>
                      </tr>
                    </table>
                  </td>
