...
// GET COOKIE
elColor = document.cookie;
// if cookie run colors
if (document.cookie) {
	if (elColor.indexOf('Teal') != -1) { leDir="tface"; }
	if (elColor.indexOf('Sky') != -1) { leDir="sface"; }
	if (elColor.indexOf('Baby') != -1) { leDir="bface"; }
